...
def chatbot():
    authenticator = IAMAuthenticator('5MdYBRMtXHCvhsdO-aBCyKwoM1HhURm_VgPy9JSpfRHK')
    ...
    session_id='https://api.eu-gb.assistant.watson.cloud.ibm.com/instances/19eedcb5-b38e-41ff-b946-ad07cb2865e4',
    input={
        'message_type': 'text',
        'text': 'Hello'
    }
...
def tts():
    ...
    with open('./speech.mp3', 'wb') as audio_file:
        res = tts.synthesize(text,voice='en-US_AllisonV3Voice', accept='audio/mp3').get_result()
